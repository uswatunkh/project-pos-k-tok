		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
			<select disabled name="id_toko" class="form-control select2" style="width: 100%;">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
			<select disabled name="id_karyawan" class="form-control select2" style="width: 100%;">
				<option value="">Please Select</option>
				<?php 
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('tgl_transaksi'),$list['tgl_transaksi']); ?>" type="text" class="form-control" name="tgl_transaksi" id="tgl_transaksi" placeholder="Tgl_transaksi" size="10">			  </div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Total_harga</label>
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('total_harga'),$list['total_harga']); ?>" type="text" class="form-control" name="total_harga" id="total_harga" placeholder="Total_harga" size="50">			  </div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Bayar</label>
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('bayar'),$list['bayar']); ?>" type="text" class="form-control" name="bayar" id="bayar" placeholder="Bayar" size="50">			  </div>
				</div>
				  </div><!-- /.box-body -->
...
/* Generated via crud engine by indonesiait.com | 2020-07-27 10:46:10 */
