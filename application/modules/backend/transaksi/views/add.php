		  ...
		  <h3 class="box-title"><?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Id toko</label>
				  <div class="col-sm-10">
			...
			<select name="id_toko" class="form-control select2" style="width: 100%;">
				...
				<?php 
					foreach($tb_toko as $rows){
						echo "<option value='".$rows['id']."' ".set_value_select(wd_set_value('id_toko'),$rows['id'])."  >".$rows['nama']."</option>";
					}
				?>
			</select>
						  </div>
				...
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Id karyawan</label>
				  <div class="col-sm-10">
			...
			<select name="id_karyawan" class="form-control select2" style="width: 100%;">
				...
				<?php 
					foreach($tb_karyawan as $rows){
						echo "<option value='".$rows['id']."' ".set_value_select(wd_set_value('id_karyawan'),$rows['id'])."  >".$rows['nama']."</option>";
					}
				?>
			</select>
						  </div>
				...
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Tgl transaksi</label>
				  <div class="col-sm-10">

				  		 <input value="<?php echo wd_set_value('tgl_transaksi'); ?>" type="text" class="form-control" name="tgl_transaksi" id="tgl_transaksi" size="10">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('total_harga'); ?>" type="text" class="form-control" name="total_harga" id="total_harga" placeholder="Total harga" size="50">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('bayar'); ?>" type="text" class="form-control" name="bayar" id="bayar" placeholder="Bayar" size="50">			  </div>
				</div>
				  </div><!-- /.box-body -->
