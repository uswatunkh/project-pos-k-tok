...
class Jenisbarang extends MY_backend
{
    function __construct()
    {
		...
		$this->breadcrumb->add_crumb('Jenis Barang');
		
		$this->data['primary_title'] = '<i class="fa fa fa-gear"></i> Jenis Barang';
		$this->data['sub_primary_title'] = '';
		
		$this->data['sub_title'] = 'Jenis Barang';
		$this->layout->set_title($this->data['sub_title']);
		
		$this->table_jenis_barang = 'jenis_barang'; 
	...
	function show(){
		...
		$this->data['list'] = $this->wd_db->get_data_row($this->table_jenis_barang,array('id'=>$id));
	...
	function save_action(){
		...
		$this->wd_db->add_dml_get_id($this->table_jenis_barang,$data);
	...
	function update_action(){
		...
		$old = $this->wd_db->get_data($this->table_jenis_barang,array('id' => $id)) ;
		...
		$this->wd_db->edit_dml($this->table_jenis_barang,$data,$where);
	...
	function delete_action(){
		...
		if($this->input->get('confirm') == null){
			$this->confirm_delete($this->table_jenis_barang,'id','id_toko');
			return;
		}
			
		$del_id = $this->session->flashdata('del_id');
		$this->rule->type('D');
		$this->wd_db->del_dml_where_in($this->table_jenis_barang,'id',$del_id);
	...
	public function dataTable() {
		$this -> load -> library('Datatable', array('model' => 'm_datatables', 'rowIdCol' => 'jenis_barang.id'));
...
/* Location: ./application/modules/jenisbarang/controllers/Jenisbarang.php */
