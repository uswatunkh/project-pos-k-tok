		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
			<select disabled name="id_jenis_barang" class="form-control select2" style="width: 100%;">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('stok'),$list['stok']); ?>" type="text" class="form-control" name="stok" id="stok" placeholder="Stok" size="50">			  </div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Satuan</label>
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('satuan'),$list['satuan']); ?>" type="text" class="form-control" name="satuan" id="satuan" placeholder="Satuan" size="50">			  </div>
				</div>
				  </div><!-- /.box-body -->
