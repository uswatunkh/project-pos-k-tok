		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input value="<?php set_value_edit_text(wd_set_value('group_name'),$list['name']); ?>" type="text" class="form-control" name="group_name" id="group_name" placeholder="Group Name" size="50">
				  </div>
				</div>
				  
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Decription</label>
				  <div class="col-sm-10">
					<input value="<?php set_value_edit_text(wd_set_value('description'),$list['description']); ?>" type="text" class="form-control" name="description" id="description" placeholder="Description" size="50">
				  </div>
				</div> 
					 ...
					 <div class="col-sm-10">
						...
						<tbody>
							...
							foreach($module as $row){
								$disable_class = "";
								$disabled = "";
								foreach($no_delete as $no_delete_row){
									if($no_delete_row["id"]==$row["id"] && ($id=="1" || $id=="2")){
										$disable_class = "checkbox-disable";
							...
							?>
								...
								<tr>
									<td class="col-sm-7">
										<div class="checkbox checkbox-primary checkbox-circle <?php echo $disable_class; ?>"> 
											<input id_value="m-<?php echo $row['id']; ?>" type="hidden" value="<?php echo $row['module_status'];?>" <?php echo $checkedModuleName;?>>
											<input <?php echo $disabled; ?> <?php echo $checkedModule;?> type="checkbox" name="roles[]" id="roles-<?php echo $row['id']; ?>" value="<?php echo $row['id']; ?>" no="<?php echo $row['id']; ?>" parent="<?php echo $row['parent']; ?>"/> 
											<label for="roles-<?php echo $row['id']; ?>"><b> <?php echo $row['tree']; ?></b> <?php if($row['module_status']=="0") echo "[parent menu]";?></label>
                                      	</div> 
									</td>
									<td class="col-sm-1">
										<div class="checkbox checkbox-primary checkbox-circle <?php echo $disable_class; ?> checkbox-only <?php if($row['module_status']=="0" || $row['support'][0]=="0")echo "display-none";?>">  
											<input id_value="a-<?php echo $row['id']; ?>" type="hidden" value="<?php echo $checkedAdminValue;?>" <?php echo $checkedAdminName;?>>
											<input <?php echo $disabled; ?> <?php echo $checkedAdmin;?> type="checkbox" id="a-<?php echo $row['id']; ?>" value="admin[]" no="<?php echo $row['id']; ?>" parent="<?php echo $row['parent']; ?>"/>
											<label for="a-<?php echo $row['id']; ?>"></label>
                                      	</div> 
									</td>
									
									<td class="col-sm-1">
										<div class="checkbox checkbox-primary checkbox-circle <?php echo $disable_class; ?> checkbox-only <?php if($row['module_status']=="0" || $row['support'][1]=="0")echo "display-none";?>">  
											<input id_value="r-<?php echo $row['id']; ?>" type="hidden" value="<?php echo $checkedReadValue;?>" <?php echo $checkedReadName;?>>
											<input <?php echo $disabled; ?> <?php echo $checkedRead;?> type="checkbox"  id="r-<?php echo $row['id']; ?>" value="read[]" no="<?php echo $row['id']; ?>" parent="<?php echo $row['parent']; ?>"/>
											<label for="r-<?php echo $row['id']; ?>"></label>
                                      	</div>  
									</td>
									
									<td class="col-sm-1">
										<div class="checkbox checkbox-primary checkbox-circle <?php echo $disable_class; ?> checkbox-only <?php if($row['module_status']=="0" || $row['support'][2]=="0")echo "display-none";?>">  
											<input id_value="c-<?php echo $row['id']; ?>" type="hidden" value="<?php echo $checkedCreateValue;?>" <?php echo $checkedCreateName;?>>
											<input <?php echo $disabled; ?> <?php echo $checkedCreate;?> type="checkbox" id="c-<?php echo $row['id']; ?>" value="create[]" no="<?php echo $row['id']; ?>" parent="<?php echo $row['parent']; ?>"/>
											<label for="c-<?php echo $row['id']; ?>"></label>
                                      	</div> 
									</td>
									
									<td class="col-sm-1">
										<div class="checkbox checkbox-primary checkbox-circle <?php echo $disable_class; ?> checkbox-only <?php if($row['module_status']=="0" || $row['support'][3]=="0")echo "display-none";?>">  
											<input id_value="u-<?php echo $row['id']; ?>" type="hidden" value="<?php echo $checkedUpdateValue;?>" <?php echo $checkedUpdateName;?>>
											<input <?php echo $disabled; ?> <?php echo $checkedUpdate;?> type="checkbox" id="u-<?php echo $row['id']; ?>" value="update[]" no="<?php echo $row['id']; ?>" parent="<?php echo $row['parent']; ?>"/>
											<label for="u-<?php echo $row['id']; ?>"></label>
                                      	</div>  
									</td>
									<td class="col-sm-1">
										<div class="checkbox checkbox-primary checkbox-circle <?php echo $disable_class; ?> checkbox-only <?php if($row['module_status']=="0" || $row['support'][4]=="0")echo "display-none";?>">  
											<input id_value="d-<?php echo $row['id']; ?>" type="hidden" value="<?php echo $checkedDeleteValue;?>" <?php echo $checkedDeleteName;?>>
											<input <?php echo $disabled; ?> <?php echo $checkedDelete;?> type="checkbox" id="d-<?php echo $row['id']; ?>" value="delete[]" no="<?php echo $row['id']; ?>" parent="<?php echo $row['parent']; ?>"/>
