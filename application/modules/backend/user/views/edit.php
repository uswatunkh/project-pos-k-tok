		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input type="password" class="form-control" name="password" id="password" placeholder="Password" size="50">
				<br>	<div id='al_password' style='display:none;color: red;font-size: 20px'>Password not match !!</div>	
						<input type="password" class="form-control" name="re_password" id="re_password" placeholder="Confirm Password" size="50">			  
				</div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Jenis</label>
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('jenis'),$list['jenis']); ?>" type="text" class="form-control" name="jenis" id="jenis" placeholder="Jenis" size="50">			  
				</div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Id_pemilik</label>
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('id_pemilik'),$list['id_pemilik']); ?>" type="text" class="form-control" name="id_pemilik" id="id_pemilik" placeholder="Id_pemilik" size="50">			  
				</div>
				</div>
				  </div><!-- /.box-body -->
