			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('email'); ?>" type="text" class="form-control" name="email" id="email" placeholder="Email" size="50">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input type="password" class="form-control" name="password" id="password" placeholder="Password" size="50">
				<br>	<div id='al_password' style='display:none;color: red;font-size: 20px'>Password not match !!</div>	
						<input type="password" class="form-control" name="re_password" id="re_password" placeholder="Confirm Password" size="50">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('jenis'); ?>" type="text" class="form-control" name="jenis" id="jenis" placeholder="Jenis" size="50">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('id_pemilik'); ?>" type="text" class="form-control" name="id_pemilik" id="id_pemilik" placeholder="Id pemilik" size="50">			  </div>
				</div>
				  </div><!-- /.box-body -->
...
/* Generated via crud engine by indonesiait.com | 2020-07-27 10:34:32 */
