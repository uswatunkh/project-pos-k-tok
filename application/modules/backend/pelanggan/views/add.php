			...
			<select name="id_toko" class="form-control select2" style="width: 100%;">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('no_hp'); ?>" type="text" class="form-control" name="no_hp" id="no_hp" placeholder="No hp" size="50">			  </div>
				</div>
...
/* Generated via crud engine by indonesiait.com | 2020-07-27 10:41:25 */
