		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<select disabled name="id_toko" class="form-control select2" style="width: 100%;">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('no_hp'),$list['no_hp']); ?>" type="text" class="form-control" name="no_hp" id="no_hp" placeholder="No_hp" size="50">			  </div>
				</div>
