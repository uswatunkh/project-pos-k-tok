		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
			<select disabled name="id_pemilik" class="form-control select2" style="width: 100%;">
				<option value="">Please Select</option>
				<?php 
					foreach($tb_user as $rows){
						echo "<option value='".$rows['id']."' ".set_value_edit_select(wd_set_value('id_pemilik'),$rows['id'],$list['id_pemilik'])." >".$rows['nama']."</option>";
					}
				?>
			</select>
						  </div>
...
/* Generated via crud engine by indonesiait.com | 2020-07-27 10:36:47 */
