...
class M_datatables extends CI_Model implements DatatableModel{
	    ...
	    public function joinArray(){
			return 
				array(
					'pelanggan pelanggan' => 'pelanggan.id = transaksi.id_pelanggan',
					'karyawan karyawan' => 'karyawan.id = transaksi.id_karyawan');
	    }
...
/* Location: ./application/modules/Transaksi/models/M_datatables.php */
