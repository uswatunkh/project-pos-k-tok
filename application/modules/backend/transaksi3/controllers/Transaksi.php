...
class Transaksi extends MY_backend
{
	...
	function show(){
		...
		$this->data['tb_pelanggan'] = $this->wd_db->select_data('select id,nama from pelanggan');
	...
	function delete_action(){
		...
		if($this->input->get('confirm') == null){
			$this->confirm_delete($this->table_transaksi,'id','id_pelanggan');
			return;
		}
...
/* Generated by IndonesiaIT Codeigniter CRUD Generator 2020-07-25 02:44:38 */
/* indonesiait.com */