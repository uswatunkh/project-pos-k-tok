		  ...
		  <h3 class="box-title"><?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Id pelanggan</label>
				  <div class="col-sm-10">
			...
			<select name="id_pelanggan" class="form-control select2" style="width: 100%;">
				...
				<?php 
					foreach($tb_pelanggan as $rows){
						echo "<option value='".$rows['id']."' ".set_value_select(wd_set_value('id_pelanggan'),$rows['id'])."  >".$rows['nama']."</option>";
					}
				?>
			</select>
						  </div>
