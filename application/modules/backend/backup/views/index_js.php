...
if($privilege['U']=="1" || $privilege['D']=="1"){
	...
	if($privilege['U']=="1"){
		$action .= '<li><a class="btn-restore" href="#">Restore DB</a></li>';
	}
...
$(function() {
	...
	var dt = $("#dt_basic").DataTable({
		...
		{ data: "wd_backup_db.name" },
		{ data: "wd_backup_db.file" },
		{ data: "wd_backup_db.date" },
		{ data: "wd_users.wd_users:username" },			{
				data: null,
	...
	$("#dt_basic tbody").on("click", ".btn-restore", function(e) {
		e.preventDefault();				
		var tr = $(this).closest("tr");
		var checkbox = [tr.attr("id")];
		
		var remote = JS_BASE_URL + "<?php echo this_module();?>/restore_db";
	...
	$("#btn_create").click(function(){
		...
		var remote = JS_BASE_URL + "<?php echo this_module();?>/save_action";
