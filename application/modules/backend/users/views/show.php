		  ...
		  <h3 class="box-title"><?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
			  ...
			  <div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input disabled value="<?php set_value_edit_text(wd_set_value('email'),$list['email']); ?>" type="text" class="form-control" name="email" id="email" placeholder="Email" size="50">
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input disabled value="<?php set_value_edit_text(wd_set_value('first_name'),$list['first_name']); ?>" type="text" class="form-control" name="first_name" id="first_name" placeholder="Name" size="50">
				  </div>
				</div>
				<div class="form-group">
				  <label for="inputEmail3" class="col-sm-2 control-label">Phone</label>
				  <div class="col-sm-10">
					<input disabled value="<?php set_value_edit_text(wd_set_value('phone'),$list['phone']); ?>" type="text" class="form-control" name="phone" id="phone" placeholder="Phone" size="50">
				  </div>
				</div>
								...
								<tr>
									<td class="col-sm-4">
										<div class="checkbox checkbox-primary checkbox-circle">
											<input disabled <?php echo $checked;?> type="checkbox" name="groups[]" id="groups-<?php echo $row['id']; ?>" value="<?php echo $row['id']; ?>"/> 
