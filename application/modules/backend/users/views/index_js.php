...
$(function() {
	...
	var dt = $("#dt_basic").DataTable({
		...
		"drawCallback" : function(oSettings) {
			...
			$id_inline = $this->urlcrypt->encode($_SESSION['user_id']);
			echo '
					$("#'.$id_inline.' input[type=checkbox]").attr("name", "");
					$("#'.$id_inline.' input[type=checkbox]").attr("id", "");
					$("#'.$id_inline.' input[type=checkbox]").attr("class", "");
					$("#'.$id_inline.' input[type=checkbox]").attr("disabled", true);
					$("#'.$id_inline.' td ul li a").remove(".btn-delete");
				';
			?>
		}
	});
