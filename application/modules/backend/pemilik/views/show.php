		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('password'),$list['password']); ?>" type="text" class="form-control" name="password" id="password" placeholder="Password" size="50">			  </div>
				</div>
				  </div><!-- /.box-body -->
