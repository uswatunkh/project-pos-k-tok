			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('password'); ?>" type="text" class="form-control" name="password" id="password" placeholder="Password" size="50">			  </div>
				</div>
				  </div><!-- /.box-body -->
...
/* Generated via crud engine by indonesiait.com | 2020-07-25 02:21:59 */
