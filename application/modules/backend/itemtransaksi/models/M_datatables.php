...
class M_datatables extends CI_Model implements DatatableModel{
		...
		public function fromTableStr() {
			return 'item_transaksi item_transaksi';
		}
	    ...
	    public function joinArray(){
			return 
				array(
					'transaksi transaksi' => 'transaksi.id = item_transaksi.id_transaksi',
					'item_barang item_barang' => 'item_barang.id = item_transaksi.id_item_barang');
	    }
...
/* Location: ./application/modules/ItemTransaksi/models/M_datatables.php */
