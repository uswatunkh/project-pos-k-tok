		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<select name="id_item_barang" class="form-control select2" style="width: 100%;">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('jml_input'),$list['jml_input']); ?>" type="text" class="form-control" name="jml_input" id="jml_input" placeholder="Jml_input" size="50">			  
				</div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Harga</label>
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('harga'),$list['harga']); ?>" type="text" class="form-control" name="harga" id="harga" placeholder="Harga" size="50">			  
				</div>
				</div>
				  </div><!-- /.box-body -->
