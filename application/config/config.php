...
$config['assets'] = $url_path.'assets/movable/';
$config['admin_dir'] = "backend";
$config['admin_email'] = "";
$config['backend_url'] = $config['base_url'].$config['admin_dir'].'/';
...
$config['sess_cookie_name'] = 'ci_session_indonesiait';
