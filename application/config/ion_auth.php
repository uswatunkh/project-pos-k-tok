...
$query = $CI->db->query('SELECT value FROM ' . $table_prefix . 'options WHERE name = "password_email"');
$password_email = $query->row();
...
*/
$config['tables']['prefix'] = $table_prefix;
...
// Dari Wd
$config['tables']['modules'] = $table_prefix . 'modules';
$config['tables']['group_privileges'] = $table_prefix . 'group_privileges';
...
$config['admin_email'] = $admin_email->value;

// Admin Email, admin@example.com
$config['default_group'] = $default_group->value;

// Default group, use name
$config['admin_group'] = $admin_group->value;
...
$config['user_extend_on_login'] = 86500;
...
$config['email_config'] = array(
	'protocol' => 'smtp',
	'smtp_host' => 'ssl://sg100.idcloudhost.com',
	//'smtp_host' => 'ssl://project.indonesiait.com',
	'smtp_port' => 465, 
	'smtp_keepalive' => TRUE,
	'smtp_user' => $admin_email->value,
	'smtp_pass' => $password_email->value,
	'mailtype' => 'html',
	'charset' => 'iso-8859-1',
    'wordwrap' => TRUE
);
