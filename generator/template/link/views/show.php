		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('title'),$list['title']); ?>" type="text" class="form-control" name="title" id="title" placeholder="Title" size="50">			  </div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Href*</label>
				  <div class="col-sm-10"><input disabled value="<?php set_value_edit_text(wd_set_value('href'),$list['href']); ?>" type="text" class="form-control" name="href" id="href" placeholder="Href" size="50">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
					...
					foreach ( $list_status as $value) {
						...
						echo "<input disabled $check value='$value[0]' type='radio' class='minimal' name='status' > $value[1] <br> ";
					}
					?>
						  </div>
				</div>
