		  ...
		  <h3 class="box-title"><?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('title'); ?>" type="text" class="form-control" name="title" id="title" placeholder="Title" size="50">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input value="<?php echo wd_set_value('href'); ?>" type="text" class="form-control" name="href" id="href" placeholder="Href" size="50">			  </div>
				</div>
			...
			<?php 				
				...
				foreach ($list_status as $value) {
					echo "<label class=' radio'><input value='$value[0]' type='radio'  class='minimal' name='status' > $value[1] </label>";
				}
				?>
						  </div>
				</div>
