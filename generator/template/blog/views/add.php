			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <input required value="<?php echo wd_set_value('judul'); ?>" type="text" class="form-control" name="judul" id="judul" placeholder="Judul blog" size="50">			  </div>
				</div>
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Tanggal</label>
				  <div class="col-sm-10">

				  		 <input value="<?php echo date("Y-m-d"); ?>"date("Y-m-d") type="text" class="form-control" name="tgl" id="tgl" size="10">			  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  		 ...
				  		 <textarea required name="deskripsi" id="deskripsi" class="textarea" placeholder="Deskripsi"><?php echo wd_set_value('deskripsi'); ?></textarea>			  </div>
				</div>
