		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('judul'),$list['judul']); ?>" type="text" class="form-control" name="judul" id="judul" placeholder="Judul" size="50">			  
				</div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Deskripsi*</label>
				  <div class="col-sm-10 col-lg-8"><textarea  name="deskripsi" id="deskripsi" class="textarea form-control" rows="5" placeholder="Deskripsi"><?php set_value_edit_text(wd_set_value('deskripsi'),$list['deskripsi']); ?></textarea>			  
				</div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">File</label>
				  <div class="col-sm-10"><input type="file"  name="file" id="file" onchange="fileHandler()" >
